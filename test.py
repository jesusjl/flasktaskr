...
class AllTest(unittest.TestCase):
    ...
    def test_not_logged_in_user_cannot_access_tasks_page(self):
        response = self.get.app('tasks/', follow_redirects=True)
    ...
    def tests_users_cannot_complete_tasls_that_are_not_created_by_them(self):
        self.create_user('Michael', 'michael@realpython',
                         'python')
        self.login('Michael', 'python')
        self.app.get('tasks/', follow_redirects='True')
        ...
        response = self.app.get('complete/1', follow_redirects=True)
        self.assertNotIn(b'The task was complete. Nice.', response.data)
