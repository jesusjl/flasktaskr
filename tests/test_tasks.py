...
class AllTest(unittest.TestCase):
    ...
    def test_task_template_display_logged_in_user_name(self):
        self.register(
    ...
    def test_user_can_see_tasks_modify_links_for_tasks_created_by_them(self):
        self.register(
            'Michael', 'michael@realpython.com', 'python',
            'python'
        )
    ...
    def test_admin_users_can_see_tasks_modify_links_for_all_tasks(self):
        self.register(
            'Michael', 'michael@realpython.com', 'python',
            'python'
        )
